  ...
  baseConfig = [
    {
      ...
      position = "top";
      modules-left = [
        "custom/distro-icon" "custom/linux" "custom/dulP"
        "custom/ddrT" "sway/workspaces" "sway/mode" "custom/dulT"
      ];
      modules-center = [ "sway/window" ];
      modules-right = [
        "custom/durS" "network" "custom/ddlS"
        "custom/durT" "pulseaudio" "custom/ddlT"
        "clock"
      ];
      "custom/linux" = {
        format = "{}";
    ...
    { # bottom bar
      ...
      modules-right = [
        "custom/ddrS" "cpu" "temperature" "custom/dulS"
        "custom/ddrT" "memory" "custom/dulT"
        "custom/ddrP" "battery"
      ];
      cpu = {
        format = "{usage}% ";
